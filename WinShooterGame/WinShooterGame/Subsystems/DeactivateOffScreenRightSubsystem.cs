...
{
    class DeactivateOffScreenRightSubsystem : Subsystem
    {
        ...
        public DeactivateOffScreenRightSubsystem(GraphicsDevice graphicsDevice)
        {
            ...
            getEntitiesCmd = EntityManager.PrepareGetAllEntitiesWithComponents("deactivate_off_screen_right_component");
        }
                    ...
                    using (SQLiteDataReader getDataReader = getComponentDataCmd.ExecuteReader())
                    {
                        if (getDataReader.Read())
                        {
                            ...
                            */
                            ...
                            if (x >= graphicsDevice.Viewport.Width + 200)
                            {
